    ...
    <>
      ...
      <div className="flex flex-col items-start self-stretch px-2.5">
        <div
          ...
          className="bg-fill-strong focus-within:border-blue-30 flex max-h-60 min-h-10 w-full cursor-text items-start gap-1.5 overflow-hidden rounded-lg border border-transparent px-3 py-2"
        >
