 ...
 * 즐겨찾기·신규는 갈 곳이 없어 비활성이고, 목록·트리는 fixture다.
 */
  ...
  if (!isSidebarOpen) {
    return (
      ...
      >
        ...
        <SnbRailItem Icon={IconDocumentSearch} label="문서 탐색" selected={isDocsMode} onClick={go('/?mode=docs')} />
    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <NavTree
          ...
          activeId={findActiveTreeId(pathname)}
