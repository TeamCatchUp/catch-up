  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        {description && <p className="text-body-small mt-1 text-gray-50">{description}</p>}
      </div>
      {children}
    </section>
  );
...
function StateRow({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-4">
      <span className="text-body-xsmall w-20 shrink-0 text-gray-50">{label}</span>
  ...
  return (
    <TooltipProvider>
      <div className="flex min-h-screen bg-white">
        {/* ── Sticky sidebar nav ── */}
        <nav className="border-neutral-3 sticky top-0 h-screen w-56 shrink-0 overflow-y-auto border-r bg-white p-4">
          <h1 className="text-heading-large text-gray-90 mb-4">UI Preview</h1>
          <ul className="space-y-1">
            {NAV_ITEMS.map((item) => (
              <li key={item}>
                <a
                  href={`#${toId(item)}`}
                  className="text-body-xsmall text-gray-70 hover:bg-neutral-2 block rounded-lg px-2 py-1.5 transition-colors"
                >
                  {item}
                </a>
              </li>
        ...
        <main className="flex-1 space-y-16 p-10">
          <div>
            <h1 className="text-gray-90 text-[28px] font-bold">CatchUp Design System</h1>
            <p className="text-body-medium mt-1 text-gray-50">
            ...
            >
              ...
              <SubSection title="Solid (Blue)">
                ...
                <StateRow label="Default">
                  <Button variant="icon-solid-blue" size="lg">
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-solid-blue" size="md">
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-solid-blue" size="sm">
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-solid-blue" size="xs">
                    <InventoryIcon className={IC_XS} />
                  </Button>
                </StateRow>
                <StateRow label="Disabled">
                  <Button variant="icon-solid-blue" size="lg" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-solid-blue" size="md" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-solid-blue" size="sm" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-solid-blue" size="xs" disabled>
                    <InventoryIcon className={IC_XS} />
                  </Button>
                </StateRow>
              </SubSection>
              ...
              <SubSection title="Outline (Gray)">
                ...
                <StateRow label="Default">
                  <Button variant="icon-outline-gray" size="lg">
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-outline-gray" size="md">
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-outline-gray" size="sm">
                    <InventoryIcon className={IC} />
                  </Button>
                </StateRow>
                <StateRow label="Disabled">
                  <Button variant="icon-outline-gray" size="lg" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-outline-gray" size="md" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-outline-gray" size="sm" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                </StateRow>
              </SubSection>
              ...
              <SubSection title="Icon Only (Gray)">
                ...
                <StateRow label="Default">
                  <Button variant="icon-only-gray" size="lg">
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-only-gray" size="md">
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-only-gray" size="sm">
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-only-gray" size="xs">
                    <InventoryIcon className={IC_XS} />
                  </Button>
                </StateRow>
                <StateRow label="Disabled">
                  <Button variant="icon-only-gray" size="lg" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-only-gray" size="md" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-only-gray" size="sm" disabled>
                    <InventoryIcon className={IC} />
                  </Button>
                  <Button variant="icon-only-gray" size="xs" disabled>
                    <InventoryIcon className={IC_XS} />
                  </Button>
                </StateRow>
              </SubSection>
              ...
              <SubSection title="Icon Only (Blue)">
                ...
                <StateRow label="Default">
                  <Button variant="icon-only-blue" size="xs">
                    <InventoryIcon className={IC_XS} />
                  </Button>
                </StateRow>
                <StateRow label="Disabled">
                  <Button variant="icon-only-blue" size="xs" disabled>
                    <InventoryIcon className={IC_XS} />
                  </Button>
                </StateRow>
              </SubSection>
            ...
            >
              ...
              <SubSection title="Solid (Primary)">
                ...
                <StateRow label="Default">
                  ...
                  <Button variant="box-solid-primary" size="sm">
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
                  <Button variant="box-solid-primary" size="xs">
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
                ...
                <StateRow label="Disabled">
                  <Button variant="box-solid-primary" size="lg" disabled>
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
                  <Button variant="box-solid-primary" size="md" disabled>
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
                  <Button variant="box-solid-primary" size="sm" disabled>
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
                  <Button variant="box-solid-primary" size="xs" disabled>
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
              ...
              <SubSection title="Outline (Gray)">
                ...
                <StateRow label="Default">
                  <Button variant="box-outline-gray" size="lg">
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
                  ...
                  <Button variant="box-outline-gray" size="xs">
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
                ...
                <StateRow label="Disabled">
                  ...
                  <Button variant="box-outline-gray" size="xs" disabled>
                    <ArrowLeftIcon className={IC} />
                    Text
                    <ArrowRightIcon className={IC} />
                  </Button>
            ...
            >
              <SubSection title="Solid (Primary)">
                <StateRow label="Large">
                  <Button variant="capsule-solid-primary" size="lg">
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                </StateRow>
                <StateRow label="Small">
                  <Button variant="capsule-solid-primary" size="sm">
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                </StateRow>
                <StateRow label="Disabled">
                  <Button variant="capsule-solid-primary" size="sm" disabled>
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                </StateRow>
              ...
              <SubSection title="Outline (Mono)">
                <StateRow label="Large">
                  <Button variant="capsule-outline-mono" size="lg">
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                </StateRow>
                <StateRow label="Small">
                  <Button variant="capsule-outline-mono" size="sm">
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                </StateRow>
                <StateRow label="Disabled">
                  <Button variant="capsule-outline-mono" size="sm" disabled>
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                </StateRow>
              ...
              <SubSection title="Outline (Blue)">
                ...
                <StateRow label="Disabled">
                  <Button variant="capsule-outline-blue" size="sm" disabled>
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                </StateRow>
              ...
              <SubSection title="Solid (Purple / Lightblue)">
                <StateRow label="Default">
                  <Button variant="capsule-solid-purple" size="sm">
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                  <Button variant="capsule-solid-light-blue" size="sm">
                    <AddSmallIcon className={IC} />
                    Text
                  </Button>
                </StateRow>
            ...
            >
              <div className="flex items-center gap-6">
                <div className="text-center">
                  <Button variant="fab-primary" size="md">
                    <AddSmallIcon className={IC} />
                  </Button>
                  <p className="text-label-xsmall mt-2 text-gray-50">Primary</p>
                </div>
                <div className="text-center">
                  <Button variant="fab-secondary" size="md">
                    <ArrowDownIcon className={IC} />
                  </Button>
                  <p className="text-label-xsmall mt-2 text-gray-50">Secondary</p>
                </div>
              </div>
            </Section>
          </div>
          ...
          <div id={toId('Text Buttons')}>
            ...
            >
              <SubSection title="Primary Blue">
                ...
                <StateRow label="Default">
                  <Button variant="text-primary-blue" size="lg">
                    <ArrowLeftIcon className={IC} />
                    더보기
                    <ArrowRightIcon className={IC} />
                  </Button>
                  <Button variant="text-primary-blue" size="md">
                    <ArrowLeftIcon className={IC} />
                    더보기
                    <ArrowRightIcon className={IC} />
                  </Button>
                  <Button variant="text-primary-blue" size="sm">
                    <ArrowLeftIcon className={IC} />
                    더보기
                    <ArrowRightIcon className={IC} />
                  </Button>
              ...
              <SubSection title="Secondary Mono">
                ...
                <StateRow label="Default">
                  <Button variant="text-secondary-mono" size="lg">
                    <ArrowLeftIcon className={IC} />
                    더보기
                    <ArrowRightIcon className={IC} />
                  </Button>
                  <Button variant="text-secondary-mono" size="md">
                    <ArrowLeftIcon className={IC} />
                    더보기
                    <ArrowRightIcon className={IC} />
                  </Button>
                  <Button variant="text-secondary-mono" size="sm">
                    <ArrowLeftIcon className={IC} />
                    더보기
                    <ArrowRightIcon className={IC} />
                  </Button>
            ...
            >
              <SubSection title="Large (로그인/회원가입)">
                <div className="max-w-md space-y-4">
                  <div>
                    <p className="text-label-xsmall mb-1 text-gray-50">Default</p>
                    <Input inputSize="lg" placeholder="아이디" />
                    <p className="text-label-xsmall text-gray-30 mt-1">
                      영문과 숫자를 포함해 4~15자 이내로 입력하세요.
                    </p>
                  </div>
                  <div>
                    <p className="text-label-xsmall mb-1 text-gray-50">Focused</p>
                    <Input inputSize="lg" placeholder="아이디" className="border-blue-30" />
                  </div>
                  <div>
                    <p className="text-label-xsmall mb-1 text-red-50">* 아이디</p>
                    <Input
                      inputSize="lg"
                      placeholder="내용을 입력해주세요."
                      defaultValue="내용을 입력해주세요.내용을 입..."
                      error
                    />
                    <p className="text-label-xsmall mt-1 text-red-50">영문, 숫자 4~15자로 입력해주세요.</p>
                  </div>
                  <div>
                    <p className="text-label-xsmall mb-1 text-gray-50">Disabled</p>
          ...
          <div id={toId('Checkbox')}>
            <Section title="Checkbox" description="다수의 항목을 선택하거나 해제할 수 있는 컴포넌트입니다.">
              <div className="space-y-4">
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <label htmlFor="terms" className="text-body-small text-gray-80 cursor-pointer">
                    이용약관에 동의합니다
                  </label>
                </div>
              </div>
          ...
          <div id={toId('Badge / Chips')}>
            ...
            >
              ...
              <SubSection title="Input Chips (텍스트 + 닫기)">
                <div className="flex flex-wrap items-center gap-3">
                  <span className="border-neutral-4 text-body-xsmall text-gray-70 inline-flex h-[25px] items-center gap-1 rounded-full border bg-white px-2.5">
                    text input <CloseIcon className="text-gray-40 size-3.5 cursor-pointer" />
                  </span>
                  <span className="border-neutral-4 text-body-xsmall text-gray-70 inline-flex h-[25px] items-center gap-1 rounded-full border bg-white px-2.5">
                    유저명 text <CloseIcon className="text-gray-40 size-3.5 cursor-pointer" />
                  </span>
                </div>
              </SubSection>
              ...
              <SubSection title="부서명 검색 Chip">
                <div className="flex items-center gap-3">
                  <span className="border-neutral-3 text-body-small text-gray-70 inline-flex h-9 items-center gap-1 rounded-lg border bg-white px-2">
                    <TagIcon className={IC} />
                    부서명
                  </span>
                  <span className="border-blue-30 bg-blue-1 text-body-small inline-flex h-9 items-center gap-1 rounded-lg border px-2 text-blue-50">
                    <TagIcon className={IC} />
                    부서명: UXUI디...
                  </span>
                </div>
          ...
          <div id={toId('Tooltip')}>
            ...
            >
              <p className="text-body-xsmall mb-2 text-gray-50">
                ...
                {[
                  ...
                  <Tooltip key={item.label}>
                    <TooltipTrigger asChild>
                      <div className="hover:bg-neutral-2 flex size-10 cursor-pointer items-center justify-center rounded-lg text-gray-50">
                        {item.icon}
                      </div>
                    </TooltipTrigger>
          ...
          <div id={toId('ScrollArea')}>
            <Section title="ScrollArea" description="SNB 팀스페이스 리스트 등 스크롤이 필요한 영역에 사용됩니다.">
              <div className="border-neutral-4 w-64 rounded-2xl border bg-white">
                <ScrollArea className="h-48 p-3">
                  {Array.from({ length: 20 }, (_, i) => (
                    <div
                      key={i}
                      className="text-body-small text-gray-80 hover:bg-neutral-2 flex h-9 items-center rounded-lg px-2"
                    >
                      팀스페이스 {i + 1}
                    </div>
                  ))}
              ...
              <SubSection title="기본 탭">
                <Tabs defaultValue="all" className="w-80">
                  ...
                  <TabsContent value="all">
                    <div className="border-neutral-3 text-body-small text-gray-70 rounded-lg border p-4">
                      전체 리스트 콘텐츠 영역
                    </div>
                  </TabsContent>
          ...
          <div id={toId('Select')}>
            <Section title="Select" description="CONTROLS > Dropdown (Title/Date/State) — Headless UI Listbox 대체.">
              <div className="flex flex-wrap gap-6">
                <div className="w-48">
                  <p className="text-label-xsmall mb-2 text-gray-50">Title</p>
                  <Select>
                    <SelectTrigger>
                ...
                <div className="w-48">
                  <p className="text-label-xsmall mb-2 text-gray-50">Date</p>
                  <Select>
                    <SelectTrigger>
                ...
                <div className="w-48">
                  <p className="text-label-xsmall mb-2 text-gray-50">State</p>
                  <Select>
                    <SelectTrigger>
          ...
          <div id={toId('DropdownMenu')}>
            ...
            >
              <div className="flex flex-wrap items-start gap-6">
                {/* Basic */}
                <div>
                  <p className="text-label-xsmall mb-2 text-gray-50">기본 드롭다운</p>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="icon-outline-gray" size="md">
                        <KebabIcon className={IC} />
                      </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent>
                      ...
                      <DropdownMenuSeparator />
                      <DropdownMenuItem>
                        <EditIcon className={IC} /> 수정하기
                      </DropdownMenuItem>
                      <DropdownMenuItem>
                        <CopyIcon className={IC} /> 복제하기
                      </DropdownMenuItem>
                      <DropdownMenuItem>
                        <ShareIcon className={IC} /> 공유하기
                      </DropdownMenuItem>
                      <DropdownMenuSeparator />
                      <DropdownMenuItem className="text-red-50">
                        <DeleteIcon className={IC} /> 삭제하기
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
                ...
                {/* With SubMenu */}
                <div>
                  <p className="text-label-xsmall mb-2 text-gray-50">서브메뉴 포함</p>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="icon-outline-gray" size="md">
                        <FilterIcon className={IC} />
                      </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className="w-56">
                      <DropdownMenuItem>
                        <SearchIcon className={IC} /> 검색
                      </DropdownMenuItem>
                      <DropdownMenuSeparator />
                      <DropdownMenuSub>
                        <DropdownMenuSubTrigger>
                          <LinkIcon className={IC} /> 연결
                        </DropdownMenuSubTrigger>
                        <DropdownMenuSubContent>
          ...
          <div id={toId('Popover')}>
            <Section
              title="Popover"
              description="Filter Dropdown, 공유 모달 등에 사용됩니다. shadow-dropdown-menu, rounded-2xl."
            >
              <div className="flex flex-wrap items-start gap-6">
                <Popover>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        {['김개발', '이디자인', '박기획'].map((name) => (
                          <div
                            key={name}
                            className="hover:bg-neutral-2 flex items-center justify-between rounded-lg px-2 py-1.5"
                          >
                            <div className="flex items-center gap-2">
                              <div className="bg-blue-5 text-label-xsmall flex size-7 items-center justify-center rounded-full text-blue-50">
                                {name[0]}
                              </div>
                      ...
                      <div className="space-y-2">
                        {['진행중', '완료', '보류', '취소'].map((status) => (
                          <div key={status} className="flex items-center gap-2">
                            ...
                            <label htmlFor={`filter-${status}`} className="text-body-small text-gray-80 cursor-pointer">
                              {status}
                            </label>
                          </div>
                        ))}
          ...
          <div id={toId('Command')}>
            <Section title="Command" description="Search Bar 자동완성, 메뉴 내 검색에 사용됩니다. cmdk 기반.">
              <div className="border-neutral-4 shadow-dropdown-menu w-80 rounded-2xl border">
                <Command>
                  ...
                  <CommandList>
                    ...
                    <CommandGroup heading="액션">
                      <CommandItem>
                        <EditIcon className={IC} /> 새 문서 작성
                      </CommandItem>
                      <CommandItem>
                        <ShareIcon className={IC} /> 공유하기
                      </CommandItem>
                      <CommandItem>
                        <DownloadIcon className={IC} /> 내보내기
                      </CommandItem>
                    </CommandGroup>
                  </CommandList>
                </Command>
          ...
          <div id={toId('Dialog')}>
            <Section
              title="Dialog"
              description="공유 모달, 태스크 상세 모달에 사용됩니다. shadow-modal, overlay: bg-alpha-white-50."
            >
                ...
                <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>태스크의 상세 정보를 확인하고 수정할 수 있습니다.</DialogDescription>
                    </DialogHeader>
                    ...
                    <DialogFooter>
                      <Button variant="box-outline-gray" size="md" onClick={() => setDialogOpen(false)}>
                        취소
                      </Button>
                      <Button variant="box-solid-primary" size="md" onClick={() => setDialogOpen(false)}>
                        저장
                      </Button>
                    </DialogFooter>
                  </DialogContent>
