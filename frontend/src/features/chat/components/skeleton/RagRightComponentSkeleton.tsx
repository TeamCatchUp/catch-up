...
const RagRightComponentSkeleton = ({ message }: RagDetailedTasksSkeletonProps) => {
  return (
    <div className="mt-2 flex w-full flex-col items-center justify-center gap-5">
      <div className="bg-blue-1 flex w-full animate-pulse flex-col items-center justify-center gap-5 rounded-2xl p-5">
      ...
      <div className="flex w-full animate-pulse flex-col gap-5">
        <div className="bg-neutral-1 h-7.5 w-full rounded-lg" />
        <div className="bg-neutral-1 h-7.5 w-[82%] rounded-lg" />
        <div className="bg-neutral-1 h-7.5 w-[71%] rounded-lg" />
        <div className="bg-neutral-1 h-7.5 w-[58%] rounded-lg" />
        <div className="bg-neutral-1 h-7.5 w-[43%] rounded-lg" />
      </div>
    </div>
  );
};
