    ...
    <div className="flex w-full flex-col gap-3">
      ...
      <div className="border-line-normal-neutral flex min-h-0 overflow-clip border-y" style={{ height: 558 }}>
        ...
        <div className="border-line-normal-neutral bg-fill-normal-normal flex min-w-0 flex-1 flex-col overflow-clip border-r">
          {/* 헤더 */}
          <div className="border-line-normal-neutral bg-fill-normal-strong text-body-xsmall text-text-normal-alternative flex h-9 shrink-0 items-center gap-1 border-b px-5">
          ...
          {sorted.length === 0 ? (
            ...
            <div className="flex min-h-0 flex-1 flex-col overflow-x-clip overflow-y-auto">
              {sorted.map((log) => {
                ...
                const badgeCls =
                  STATUS_BADGE_CLASS[statusLabel] ?? 'bg-fill-normal-interaction-hover text-text-normal-alternative';
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'border-line-normal-neutral flex h-12.5 shrink-0 cursor-pointer items-center gap-1 border-b px-5 text-left',
                      isActive
                  ...
                  >
                    ...
                    <div className="flex w-13.75 shrink-0 items-center">
                      <div className="bg-fill-normal-strong border-line-normal-neutral flex items-center justify-center rounded-full border p-1">
                        <ServiceIcon service={log.service} className={iconCls} />
                      </div>
                    </div>

                    {/* 실행 일자 */}
                    <div className="text-body-xsmall text-text-normal-normal min-w-25 flex-1 truncate text-center">
                      {formatDate(log.executedAt)}
                    </div>

                    {/* 구분 */}
                    <div className="text-body-xsmall text-text-normal-normal flex-1 truncate text-center">
                    ...
                    <div className="flex w-32 min-w-32 items-center justify-center gap-1.5">
                      ...
                      <span className="text-body-xsmall text-text-normal-normal truncate">{log.userName}</span>
                    </div>
        ...
        {/* 우측: 디테일 패널 */}
        <div className="bg-fill-normal-normal flex min-w-0 flex-1 flex-col overflow-y-auto py-5 pl-6">
          {!selectedLog ? (
