...
const IntegrationAccountsSection = ({
  ...
  <div className="flex flex-col gap-2">
    ...
    <div className="border-edge-assistive flex flex-col overflow-clip rounded-xl border">
      {INTEGRATION_ACCOUNTS.map((account, index) => {
        ...
        return (
          <div
            key={account.service}
            className={cn(
              'border-edge-assistive flex h-15.75 shrink-0 items-center gap-5 overflow-clip px-4 py-2',
