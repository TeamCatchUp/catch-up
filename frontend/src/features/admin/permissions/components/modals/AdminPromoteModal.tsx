    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="flex h-9 items-center justify-between">
          <DialogTitle className="text-heading-medium text-text-normal-normal">Admin 권한 부여</DialogTitle>
        ...
        <div className="border-line-normal-neutral flex w-90 flex-col gap-4 border-t pt-4">
          {/* 권한 정보 테이블 */}
          <div className="flex flex-col gap-1.5">
            <span className="text-body-small text-text-normal-normal">권한 정보</span>
            <div className="border-line-normal-normal flex h-12 items-center border-y">
              <div className="bg-fill-primary-normal-assistive flex h-full w-36.25 items-center px-4">
                <span className="text-body-small text-text-normal-neutral">부여할 멤버</span>
              </div>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-1">
              <span className="text-body-small text-text-normal-normal">권한 부여 사유를 선택해주세요.</span>
