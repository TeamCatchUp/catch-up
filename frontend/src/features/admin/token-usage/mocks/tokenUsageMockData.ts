...
export const MOCK_ORG_MEMBERS: OrgMember[] = [
  { id: '1', name: '팀원G', team: '사업개발팀', position: 'PM', role: '루트 어드민' },
  { id: '2', name: '직원20', team: '부서O', position: '디자이너', role: '일반' },
  { id: '3', name: '직원04', team: '부서O', position: '개발자', role: '일반' },
  { id: '4', name: '박지현', team: '부서O', position: '기획자', role: '일반' },
  { id: '5', name: '최영호', team: '부서O', position: 'PM', role: '일반' },
  { id: '6', name: '정수진', team: '부서O', position: '디자이너', role: '일반' },
  { id: '7', name: '한동훈', team: '부서O', position: '개발자', role: '일반' },
  { id: '8', name: '오세린', team: '부서O', position: '기획자', role: '일반' },
  { id: '9', name: '윤재석', team: '부서O', position: '개발자', role: '일반' },
  { id: '10', name: '송하나', team: '부서O', position: '디자이너', role: '일반' },
  { id: '11', name: '임도현', team: '부서O', position: 'PM', role: '일반' },
];
