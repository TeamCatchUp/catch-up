...
function EntityChip({ icon: Icon }: EntityChipProps) {
  return (
    <span className="border-line-normal-normal bg-fill-normal-strong text-text-normal-alternative rounded-md2 inline-flex shrink-0 items-center justify-center border p-0.5">
