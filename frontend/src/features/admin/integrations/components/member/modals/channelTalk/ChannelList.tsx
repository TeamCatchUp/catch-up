...
function ChannelList({
  ...
  return (
    <div className="border-line-normal-neutral flex w-85 flex-col border-r">
      <div className="flex flex-col gap-3 px-4 pt-4">
        <div className="flex h-7 items-center justify-between">
          <span className="text-heading-medium text-text-normal-strong pl-2">채널</span>
          <button
            type="button"
            onClick={onToggleAll}
          ...
          >
            ...
            <span className="text-body-xsmall text-text-normal-normal whitespace-nowrap">전체 선택하기</span>
          </button>
        </div>
        <span className="text-body-xsmall text-text-normal-alternative pl-2">전체 {channels.length}개</span>
      </div>
            ...
            <li key={channel.channel_id}>
              <button
                ...
                className={cn(
                  ...
                  isVisible ? 'bg-fill-primary-normal-neutral' : 'hover:bg-fill-normal-strong',
                )}
