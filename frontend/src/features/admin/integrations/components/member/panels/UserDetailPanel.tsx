    ...
    <section className="bg-fill-normal-normal overflow-clip pt-5 pb-5 pl-6">
      <div className="flex h-full flex-col gap-4">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          <span className="text-heading-medium text-text-normal-normal truncate">{selectedRow.userName}</span>
        </div>
        ...
        <div className="flex flex-col gap-9">
          <div className="text-body-small flex flex-col gap-2">
            <div className="flex w-full items-center gap-14">
              ...
              <span className="text-text-normal-neutral min-w-0 flex-1 truncate">{selectedRow.email}</span>
            </div>
          </div>

          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              <IconCloudCheckFilled className="text-text-normal-assistive size-6" />
              <h3 className="text-heading-small text-text-normal-neutral">연동된 계정 정보</h3>
            </div>

            <div className="border-line-normal-assistive flex h-63 w-119 flex-col overflow-clip rounded-xl border">
              {INTEGRATION_ACCOUNTS.map((account, index) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      'border-line-normal-assistive flex h-15.75 w-119 shrink-0 items-center gap-5 overflow-clip px-4',
