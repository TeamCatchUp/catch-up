    ...
    <div className="flex w-full flex-col gap-16">
      ...
      <section className="flex flex-col gap-5">
        ...
        <div className="text-label-medium text-content-normal">
          ...
          <br />
          <p>
            &apos;나의 비공개 문서&apos;나 &apos;접근 권한이 있는 프로젝트&apos;의 내용까지 검색하고자 하는
            <br />
            여러분의 귀한 의견을 깊이 공감하며 수용하고 있어요.
          </p>
          <br />
          <p>
            현재 Catch Up은 개별 사용자의 데이터 접근 권한(ACL)을 엄격하게 통제하여,
            <br />
            &apos;오직 허락된 정보&apos;만 안전하게 연결하는 고도화된 보안 환경을 구축 중입니다.
          </p>
          <br />
          <p>보안은 결코 타협할 수 없는 최우선 가치이기에, 안정성이 검증될 때까지 조금만 기다려주세요.</p>
          <br />
          <p>
            공개된 지식을 넘어, 고객님만의 고유한 업무 맥락까지
            <br />
            가장 완벽하고 안전하게 지원해 드릴 수 있도록 최선을 다하겠습니다.
          </p>
          <br />
          <p>
            보안에 대한 어떤 타협도 없이,
            <br />
            공개된 정보부터 나만의 지식까지 연결할
            <br />
            Catch Up의 미래를 지켜봐주세요:)
          </p>
        </div>
      </section>
    </div>
