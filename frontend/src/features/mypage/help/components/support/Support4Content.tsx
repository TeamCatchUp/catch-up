  ...
  return (
    <div className="flex w-full flex-col gap-16">
      ...
      <section className="flex flex-col gap-5">
        <h2 className="text-heading-xlarge text-text-normal-strong">1. 검색 결과가 텅 비었나요?</h2>

        <div className="flex flex-col gap-1.5">
          <h3 className="text-heading-medium text-text-normal-strong">혹시 방금 작성하신 글인가요?</h3>
          <div className="text-label-medium text-text-normal-normal">
            <p>
        ...
        <div className="flex flex-col gap-1.5">
          <h3 className="text-heading-medium text-text-normal-strong">혹시 &apos;비공개&apos;로 설정된 글인가요?</h3>
          <div className="text-label-medium text-text-normal-normal">
            <p>
      ...
      <section className="flex flex-col gap-6">
        <div className="flex flex-col gap-5">
          <h2 className="text-heading-xlarge text-text-normal-normal">2. 답변이 원하던 방향과 조금 빗나갔나요?</h2>

          <div className="flex flex-col gap-1.5">
            <h3 className="text-heading-medium text-text-normal-strong">질문의 폭을 조금만 더 좁혀주세요.</h3>
            <div className="text-label-medium text-text-normal-normal">
              <p>
      ...
      <section className="flex flex-col gap-6">
        <div className="flex flex-col gap-5">
          <h2 className="text-heading-xlarge text-text-normal-normal">3. 화면이 멈추거나 에러 메시지가 떴나요?</h2>

          <div className="flex flex-col gap-1.5">
            <h3 className="text-heading-medium text-text-normal-strong">새로고침을 한 번 해주세요.</h3>
            <div className="text-label-medium text-text-normal-normal">
              <p>
          ...
          <div className="flex flex-col gap-1.5">
            <h3 className="text-heading-medium text-text-normal-strong">
        ...
        <div className="bg-fill-normal-strong border-line-normal-assistive flex flex-col gap-3 rounded-xl border px-5 py-4">
          <ul className="text-label-medium text-text-normal-normal list-disc space-y-3 pl-6">
      ...
      {/* 4. 그래도 해결되지 않는다면 */}
      <section className="flex flex-col gap-5">
        <h2 className="text-heading-xlarge text-text-normal-normal">4. 그래도 해결되지 않는다면 (Support)</h2>
        ...
        <div className="flex flex-col gap-1.5">
          <h3 className="text-heading-medium text-text-normal-strong">격식은 생략하셔도 좋습니다.</h3>
          <div className="text-label-medium text-text-normal-normal">
            <p>
        ...
        <div className="flex flex-col gap-1.5">
          <h3 className="text-heading-medium text-text-normal-strong">여러분의 질문이 동료의 해답이 됩니다.</h3>
          <div className="text-label-medium text-text-normal-normal">
            <p>
