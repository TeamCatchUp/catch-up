      ...
      <div className="flex flex-col gap-2.5">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <AlarmFilled className="text-text-normal-assistive h-5 w-5" />
            <span className="text-body-small text-text-normal-alternative">운영 시간</span>
          </div>
          <span className="text-body-small text-text-normal-normal">매일 10:00-18:00</span>
        </div>

        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <CommentFilled className="text-text-normal-assistive h-5 w-5" />
            <span className="text-body-small text-text-normal-alternative">응답 시간</span>
          </div>
          <span className="text-body-small text-text-normal-normal">매일 10:00-18:00</span>
        </div>
      </div>
