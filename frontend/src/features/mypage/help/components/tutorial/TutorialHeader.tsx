...
export default function TutorialHeader({ prevLabel, prevHref, currentLabel }: TutorialHeaderProps) {
  ...
  return (
    <div className="border-b-edge-neutral bg-fill-normal z-base sticky top-0 flex h-13 shrink-0 items-center justify-between border-b px-16 py-2">
      {/* 좌측: 브레드크럼 */}
      <div className="flex items-center justify-center">
        <Link
          href={prevHref}
          className="hover:bg-fill-interaction-hover flex items-center gap-1.5 rounded-xl px-2 py-1"
        >
          <Help className="text-content-alternative h-5 w-5" />
      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          className="border-edge-neutral hover:border-edge-normal hover:bg-fill-interaction-hover active:border-edge-strong active:bg-fill-interaction-pressed bg-fill-normal flex cursor-pointer items-center gap-1.5 rounded-lg border px-2.5 py-1.5 transition-colors"
        >
