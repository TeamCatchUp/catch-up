  ...
  return (
    <div className="border-b-neutral-3 sticky top-0 z-10 flex h-13 shrink-0 items-center justify-between border-b bg-white px-16 py-2">
      ...
      <div className="flex items-center justify-center">
        <Link href={prevHref} className="hover:bg-neutral-2 flex items-center gap-1.5 rounded-xl px-2 py-1">
        ...
        <span className="text-heading-small text-gray-80 max-w-50 truncate px-2 py-1">{currentLabel}</span>
      </div>
      ...
      <div className="flex items-center gap-1.5">
        ...
        >
          <Add className="text-gray-70 h-5 w-5" />
