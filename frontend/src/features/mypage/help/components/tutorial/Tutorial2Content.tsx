    ...
    <div className="flex w-full flex-col gap-16">
      ...
      <section className="flex flex-col gap-6">
        <div className="flex flex-col gap-4">
          <h2 className="text-heading-xlarge text-text-normal-strong">정확도를 올리는 질문 습관</h2>
          <div className="text-label-medium text-text-normal-normal">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-heading-large text-text-normal-normal">
              1. 기능명 같은 &apos;단서&apos;를 하나 주세요
            </h3>
            <div className="text-label-medium text-text-normal-normal">
          ...
          {/* 2. 목적을 한 줄로 알려주세요 */}
          <div className="flex flex-col gap-2">
            <h3 className="text-heading-large text-text-normal-normal">2. 목적을 한 줄로 알려주세요</h3>
            <div className="text-label-medium text-text-normal-normal">
              <p>
            ...
            <ExampleBox>
              ...
              <p className="text-text-normal-alternative">
          ...
          {/* 3. 기간을 말해주면 더 좋아요 */}
          <div className="flex flex-col gap-2">
            <h3 className="text-heading-large text-text-normal-normal">3. 기간을 말해주면 더 좋아요</h3>
            <div className="text-label-medium text-text-normal-normal">
              <p>언제부터의 기록을 봐야 하는지 알면, 최신/관련 정보를 더 잘 좁힐 수 있어요.</p>
            </div>
            <ExampleBox>
              <p className="text-text-normal-normal">[예시]</p>
              <p className="text-text-normal-alternative">- 오늘 오전부터 / 어제 배포 이후</p>
              <p className="text-text-normal-alternative">- 최근 1주 / 최근 1달</p>
              <p className="text-text-normal-alternative">- 2월 초부터 지금까지</p>
            </ExampleBox>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-6">
        <div className="flex flex-col gap-4">
          <h2 className="text-heading-xlarge text-text-normal-strong">골라 쓰는 상황별 질문 템플릿</h2>
          <div className="text-label-medium text-text-normal-normal">
        ...
        <ExampleBox>
          <p className="text-body-medium text-text-normal-alternative">[예시]</p>
          <div className="text-label-medium text-text-normal-alternative">
            <p>- 유사한 사례 찾기</p>
            <p>
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-heading-xlarge text-text-normal-strong">완벽하게 쓰실 필요 없어요.</h2>
        <div className="text-label-medium text-text-normal-normal">
