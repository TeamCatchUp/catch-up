  ...
  return (
    <div className="bg-background-normal-normal flex flex-1">
      <main className="flex w-full flex-col px-6 pt-9 pb-30 lg:px-16">
        <div className="mx-auto flex w-full max-w-260 flex-col gap-3">
          <Button
            asChild
          ...
          <div className="border-line-normal-neutral bg-fill-normal-assistive-dark flex w-full flex-wrap items-start gap-x-14 gap-y-6 rounded-3xl border px-8 pt-8 pb-16">
            <article className="flex min-w-0 flex-1 flex-col gap-14 lg:max-w-170 lg:min-w-100">
