  ...
  return (
    <section className="flex flex-col gap-3">
      <div className="flex flex-col gap-0.5">
        ...
        <p className="text-body-small text-gray-50">서비스 이용을 위한 약관과 정책을 확인하세요.</p>
      </div>
      ...
      <div className="flex gap-5">
        {POLICY_ITEMS.map((item) => (
          <Link
            key={item.label}
            href="#"
            className="border-neutral-3 hover:bg-neutral-1 flex w-122.5 shrink-0 items-center justify-between rounded-xl border px-5 py-3 transition-colors"
          >
