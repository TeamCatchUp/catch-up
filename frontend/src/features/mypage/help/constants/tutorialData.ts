export const TUTORIALS = [
  {
    ...
    heroImage: '/image/tutorial-1-hero.jpg',
  },
  {
    id: 2,
    category: '튜토리얼',
    title: '원하는 답을 한 번에 얻는 비결',
    heroImage: '/image/tutorial-2-hero.jpg',
  },
  {
    id: 3,
    category: '튜토리얼',
    title: '정확도를 올리는 출처 확인 방법',
    heroImage: '/image/tutorial-3-hero.jpg',
  },
] as const;
...
export const TUTORIAL_1_FEATURE_CARDS = [
  {
    ...
    image: '/image/tutorial-1-card-1.png',
  },
  {
    title: '답을 먼저 보여줘요: 핵심 요약',
    description:
      '검색 결과를 그대로 던지지 않아요.\n질문에 맞는 핵심만 먼저 정리해서\n"지금 필요한 답"부터 볼 수 있게 해요.',
    image: '/image/tutorial-1-card-2.png',
  },
  {
  ...
  },
  {
    ...
    image: '/image/tutorial-1-card-5.jpg',
  },
] as const;
