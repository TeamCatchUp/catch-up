...
const EmbeddingRetryModal = ({
  ...
  return (
    <Dialog open={open} onOpenChange={isLoading ? undefined : onOpenChange}>
      <DialogContent
        hideClose
        className="border-edge-normal bg-fill-normal shadow-modal flex w-140 flex-col gap-4 rounded-3xl border p-0 py-5"
      >
        ...
        {isLoading ? (
          <div className="border-edge-assistive flex flex-col gap-3 border-t px-6 pt-6">
            ...
            <p className="text-body-small text-content-neutral">재시도가 완료되면 창이 바로 꺼집니다.</p>
          </div>
        ) : (
          <>
