  ...
  return (
    <div className="border-neutral-3 flex flex-col gap-10 overflow-clip rounded-xl border bg-white p-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-label-small text-gray-80">
          데이터 수집을 허용할 채널에 접속하여 /invite @CatchupConnector 명령어를 입력해 봇을 초대해주세요. 정보 보호를
          위해 개인 간 다이렉트 메시지(DM) 및 그룹 DM은 철저히 연동 대상에서 제외됩니다.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-label-small text-gray-80">
          Catch Up 화면에서 봇이 정상적으로 초대된 채널을 확인한 뒤 동기화를 시작합니다. 긴 스레드의 대화라도 AI가
