...
const SlackGuideSection = () => {
  return (
    <div className="border-edge-neutral flex flex-col gap-10 overflow-clip rounded-xl border bg-fill-normal p-6">
      ...
      {/* 1. 워크스페이스 연결 */}
      <div className="flex flex-col gap-2">
        <h4 className="text-heading-medium text-content-normal">1. 워크스페이스 연결</h4>
        <p className="text-label-small text-content-normal">
        ...
        <div className="border-edge-normal flex items-start gap-4 rounded-xl border px-3 py-2">
      ...
      {/* 2. Catch Up 봇 초대 */}
      <div className="flex flex-col gap-2">
        <h4 className="text-heading-medium text-content-normal">2. Catch Up 봇 초대</h4>
        <p className="text-label-small text-content-normal">
      ...
      {/* 3. 채널 확인 및 동기화 */}
      <div className="flex flex-col gap-2">
        <h4 className="text-heading-medium text-content-normal">3. 채널 확인 및 동기화</h4>
        <p className="text-label-small text-content-normal">
