    ...
    <div className="border-neutral-3 flex flex-col gap-10 overflow-clip rounded-xl border bg-white p-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-label-small text-gray-80">
          공식 문서에는 없는 진짜 이유와 빠른 결정들은 보통 Slack 스레드 어딘가에 남아있습니다. 하지만
          과거의 대화를 찾으려 스크롤을 올리는 일은 팀 전체의 시간 낭비입니다. Catch Up은 대화 속에 숨은
          맥락을 찾아, 누가 알아? 하고 사람을 부르는 일을 줄여줍니다.
        </p>
      </div>

      {/* 1. 워크스페이스 연결 */}
      <div className="flex flex-col gap-2">
        <h4 className="text-heading-medium text-gray-80">1. 워크스페이스 연결</h4>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-label-small text-gray-80">
          데이터 수집을 허용할 채널에 접속하여 /invite @CatchupConnector 명령어를 입력해 봇을
          초대해주세요. 정보 보호를 위해 개인 간 다이렉트 메시지(DM) 및 그룹 DM은 철저히 연동 대상에서
          제외됩니다.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-label-small text-gray-80">
          Catch Up 화면에서 봇이 정상적으로 초대된 채널을 확인한 뒤 동기화를 시작합니다. 긴 스레드의
          대화라도 AI가 핵심만 먼저 정리하여 답을 주고, 필요할 땐 원문 스레드로 바로 넘어가 전체 맥락을
          확인할 수 있습니다.
        </p>
      </div>

      {/* 클로징 */}
      <p className="text-label-small text-black">
        대화는 흘러가도, 팀이 합의한 지식은 남겨둡니다.
      </p>
    </div>
  );
};
