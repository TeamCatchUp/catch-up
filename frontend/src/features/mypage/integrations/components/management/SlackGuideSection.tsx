  ...
  return (
    <div className="border-neutral-3 flex flex-col gap-10 overflow-clip rounded-xl border bg-white p-6">
      ...
      <div className="flex flex-col gap-2">
        <h4 className="text-heading-medium text-gray-80">결정이 내려진 순간의 대화, 휘발되지 않는 자산으로</h4>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="border-neutral-4 flex items-start gap-4 rounded-xl border px-3 py-2">
          <IconSlack className="size-6 shrink-0" />
          <div className="flex min-w-0 flex-col">
            <span className="text-body-xsmall text-gray-80">Slack account</span>
            <span className="text-label-xsmall truncate text-gray-50">
