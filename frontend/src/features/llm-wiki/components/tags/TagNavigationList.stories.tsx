...
const meta = {
  ...
  parameters: {
    ...catchupParameters({
      ...
      dataNotes: [
        '⚠️ 2026-08-13 재실측: 새 대시보드(17595:148922)에서 태그 탐색 영역이 소멸했다 — 검색바+필터 칩 구조로 교체. 스펙 노드(17762:103078)는 시트에 잔존하나 소비처가 미정이다. 폐기 여부는 디자이너 질문 #29 — 회신 전까지 컴포넌트·스토리는 동결 유지.',
