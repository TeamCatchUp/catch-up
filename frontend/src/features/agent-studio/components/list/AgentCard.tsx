  ...
  return (
    <article className="bg-fill-primary-normal-assistive flex h-70.75 min-w-80 flex-1 flex-col items-start gap-3 rounded-xl p-3">
      ...
      <div className="border-line-normal-normal bg-fill-normal-assistive-dark flex w-full flex-1 flex-col items-end justify-between gap-4 overflow-hidden rounded-xl border p-5">
        <div className="flex h-23.75 w-full flex-col items-start gap-3">
          <h3 className="text-heading-medium text-text-normal-normal w-full truncate">{agent.title}</h3>
          <p className="text-body-small text-text-normal-alternative line-clamp-3 w-full">{agent.description}</p>
          <div className="text-body-xsmall text-text-normal-alternative flex h-6 items-center gap-2">
