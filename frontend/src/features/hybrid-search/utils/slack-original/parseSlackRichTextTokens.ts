...
import type { SlackRichTextToken } from '@/features/hybrid-search/types/slackOriginalModel';
...
export function richElementsToTokens(
...
export function richElementsToPlainText(
  elements: SlackRichTextElementRaw[] | undefined,
  usersById: Record<string, SlackUserMetadata>,
): string {
