...
export function JiraGuideCard({ onClose }: GuideCardProps) {
  return (
    <div className="border-edge-neutral shadow-card flex w-190 flex-col items-start gap-8 rounded-3xl border bg-fill-normal p-5">
      <div className="flex flex-col items-start gap-5 self-stretch">
        <div className="flex items-center justify-between self-stretch">
          ...
          <button onClick={onClose} className="flex h-7 w-7 cursor-pointer items-center justify-center gap-2.5 p-0.5">
            <IconX className="h-7 w-7 text-content-alternative" />
          </button>
        </div>
