...
const LinkModal = () => {
  return (
    <div
      ...
      className="shadow-dropdown-menu border-neutral-4 h-45.5 w-63 gap-0.5 rounded-2xl border bg-white px-1.5 py-2"
    >
      <h2 id="link-model-title" className="sr-only">
        외부 서비스 연결
      </h2>

      <button className="flex h-10 w-59.5 cursor-pointer items-center justify-between p-2">
