...
const LinkModal = () => {
  return (
    <div className="shadow-dropdown-menu border-neutral-4 h-[182px] w-[281px] gap-0.5 rounded-2xl border bg-white px-1.5 py-2">
      ...
      <button className="flex h-10 w-[269px] cursor-pointer items-center justify-between p-2">
        <div className="flex gap-2">
          <ConfluenceLogo className="h-5 w-5" />
      ...
      <button className="flex h-10 w-[269px] cursor-pointer items-center justify-between p-2">
        <div className="flex gap-2">
          <GithubLogo className="h-5.5 w-6" />
      ...
      <button className="flex h-10 w-[269px] cursor-pointer items-center justify-between p-2">
        <div className="flex gap-2">
          <SlackLogo className="h-5.5 w-5.5" />
