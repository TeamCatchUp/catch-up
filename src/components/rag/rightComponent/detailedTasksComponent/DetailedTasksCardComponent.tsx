...
//   const [showSelectionBar, setShowSelectionBar] = useState<Record<number, boolean>>({});
...
//       {checkModal && <SelectionBarModal onClose={() => setShowSelectionBar(false)} selectedTasks={selectedTasks} totalCheckedCount={totalCheckedCount} onSubtaskToggle={handleSubtaskToggleFromModal} />}
//     </div>
//   );
// };
