  ...
  return (
    <div className="flex h-[906px] w-[1440px] items-center justify-between bg-white p-10">
      ...
      <div className="flex flex-[1_0_0] items-center gap-2.5 self-stretch px-[120px] py-[114px]">
        <div className="flex w-[338px] flex-[1_0_0] flex-col items-start gap-24">
          ...
          <div className="flex flex-col items-start gap-10 self-stretch">
            <div className="flex flex-col items-start gap-5 self-stretch">
              ...
              <div className="flex min-w-10 cursor-pointer items-center justify-center gap-1 self-stretch rounded-xl bg-blue-50 px-4 py-2.5">
                <button onClick={handleGoogleLogin} className="text-body-large cursor-pointer text-white">
                  구글 계정으로 계속하기
                </button>
              </div>
            </div>
