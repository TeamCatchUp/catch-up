...
class GithubPrV2BackfillService(
    ...
    connector = "github"
    entity_type = "pr"
    log_event_prefix = "github_pr_v2_backfill"
    ...
    def _fetch_candidate_seed_page_for_target_sync(
        self,
        target: BackfillTarget,
        cursor: GithubPrSeedCursor | None,
        limit: int,
    ) -> list[BackfillSeed]:
    ...
    def _cursor_from_last_seed(self, seed: BackfillSeed) -> GithubPrSeedCursor:
        return GithubPrSeedCursor(
