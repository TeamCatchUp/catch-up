...
from catchup.db.models import ConfluenceUser, UserRole
...
from catchup.events.enums import EventType, UserOnboardingEventAction
...
@audit_log(
    ...
    event_action=UserOnboardingEventAction.COMPLETED
)
