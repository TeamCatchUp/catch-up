...
from catchup.rag.nodes.generate_vector_queries.prompt import VECTOR_QUERIES_GENERATION_PROMPT
...
async def generate_vector_queries_node(state: AgentState):
    ...
    try:
        ...
        logger.warning(f"Vector query를 생성하는 데 실패했습니다. 재작성된 쿼리를 사용합니다.: {e}")
