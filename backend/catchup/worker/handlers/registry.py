...
_HANDLERS: dict[HandlerKey, IngestionHandlerProtocol] = {
    HandlerKey.of(connector=SyncConnector.SLACK, sync_type=SyncType.FULL): SlackFullSyncHandler(),
    HandlerKey.of(connector=SyncConnector.SLACK, sync_type=SyncType.INCREMENTAL): SlackIncrementalHandler(),
    HandlerKey.of(connector=SyncConnector.GITHUB, sync_type=SyncType.FULL): GithubFullSyncHandler(),
    HandlerKey.of(connector=SyncConnector.GITHUB, sync_type=SyncType.INCREMENTAL): GithubIncrementalHandler(),
    HandlerKey.of(connector=SyncConnector.JIRA, sync_type=SyncType.FULL): JiraFullSyncHandler(),
    HandlerKey.of(connector=SyncConnector.JIRA, sync_type=SyncType.INCREMENTAL): JiraIncrementalHandler(),
    HandlerKey.of(connector=SyncConnector.CONFLUENCE, sync_type=SyncType.FULL): ConfluenceFullSyncHandler(),
    HandlerKey.of(connector=SyncConnector.CONFLUENCE, sync_type=SyncType.INCREMENTAL): ConfluenceIncrementalHandler(),
}
