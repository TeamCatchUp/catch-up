...
class Settings(BaseSettings):
    ...
    # async keyword search 전용 풀: 동시 사용자 수 기준으로 산정 (thread pool과 무관)
    ...
    VECTOR_STORE_V2_BACKFILL_CRON_HOUR: int = 11
    VECTOR_STORE_V2_BACKFILL_CRON_MINUTE: int = 10
    ...
    # Slack Rate Limit Control
    SLACK_API_RPM_LIMIT: int = 50
    ...
    CHANNEL_TALK_DOCUMENTS_API_MAX_RETRY_ATTEMPTS: int = 2
    CHANNEL_TALK_DOCUMENTS_API_MAX_WAIT_SECONDS_PER_CALL: int = 30
    ...
    # TODO : 0.6.6 배포 시 MAX_PAGES 하향 조정
    CONFLUENCE_INCREMENTAL_DELETED_POLL_MAX_PAGES: int = 20
    CHANNEL_TALK_DOCUMENT_DUE_SCAN_INTERVAL_MINUTES: int = 15
    CHANNEL_TALK_DOCUMENT_INCREMENTAL_LOOKBACK_OVERLAP_MINUTES: int = 5
    CHANNEL_TALK_DOCUMENT_INCREMENTAL_POLL_STALE_MINUTES: int = 60
    CHANNEL_TALK_DOCUMENT_INCREMENTAL_MAX_PAGES: int = 20
